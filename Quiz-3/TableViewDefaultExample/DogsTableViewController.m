...
//
//  Created by Cesar Brenes on 10/29/16.
...
-(void)createDictionary{
    NSDictionary *firstDictionary = @{NAME_KEY:@"Bruno", COLOR_KEY:@"NEGRO1"};
    NSDictionary *secondDictionary = @{NAME_KEY:@"Bruno2", COLOR_KEY:@"NEGRO2"};
    NSDictionary *thirdDictionary = @{NAME_KEY:@"Bruno3", COLOR_KEY:@"NEGRO3"};
